...
public class pergunta03 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta03 frame = new pergunta03();
	...
	public pergunta03() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta03.class.getResource("/imagens/dinizMimir.jpg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Da sono pq eh cedo ok?");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta04 tela = new pergunta04();
					tela.setVisible(true);
					pergunta03.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Esta mimindo porque ?");
