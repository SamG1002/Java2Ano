...
public class pergunta06 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta06 frame = new pergunta06();
	...
	public pergunta06() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta06.class.getResource("/imagens/ceniCavalodeTroia.jpeg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Quer garantir a classificao do sao paulo indo pro adversario ne");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta07 tela = new pergunta07();
					tela.setVisible(true);
					pergunta06.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Oque ele quer no flamengo?");
