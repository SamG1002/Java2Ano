...
public class pergunta10 extends JFrame {
	...
	public pergunta10() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta10.class.getResource("/imagens/lucianoRonaldo.jpeg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Nunca vi melhor");
		...
		JLabel lblNewLabel_1 = new JLabel("Luciano eh bom em java?");
