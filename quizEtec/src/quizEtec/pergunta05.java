...
public class pergunta05 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta05 frame = new pergunta05();
	...
	public pergunta05() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta05.class.getResource("/imagens/batuqueiro.png")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Samba po");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta06 tela = new pergunta06();
					tela.setVisible(true);
					pergunta05.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Qual Musica ta batucando?");
