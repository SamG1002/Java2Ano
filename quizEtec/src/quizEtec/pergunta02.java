...
public class pergunta02 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta02 frame = new pergunta02();
	...
	public pergunta02() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta02.class.getResource("/imagens/dinizSedutor.jpg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Ta em crise, Chama o Mengao");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta03 tela = new pergunta03();
					tela.setVisible(true);
					pergunta02.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Quando olha assim ele quer?");
