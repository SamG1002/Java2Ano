...
public class pergunta09 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta09 frame = new pergunta09();
	...
	public pergunta09() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta09.class.getResource("/imagens/tiririca.jpg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "O maluco eh engracado slk");
		...
		JLabel lblNewLabel_1 = new JLabel("Reinaldo tiririca eh bom?");
