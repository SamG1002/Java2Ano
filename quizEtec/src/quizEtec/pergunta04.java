...
public class pergunta04 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta04 frame = new pergunta04();
	...
	public pergunta04() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta04.class.getResource("/imagens/covidDiniz.jpg")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Felipe Neto politico po");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta05 tela = new pergunta05();
					tela.setVisible(true);
					pergunta04.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Diniz esta pensando noque?");
