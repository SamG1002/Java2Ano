...
public class pergunta07 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pergunta07 frame = new pergunta07();
	...
	public pergunta07() {
		...
		lblNewLabel.setIcon(new ImageIcon(pergunta07.class.getResource("/imagens/impostorHugoMonstro.png")));
		...
		btnDica.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Cara entregou no pe do brenner ne man");
		...
		btnProsseguir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(bg.isSelected(null)){
					...
					pergunta08 tela = new pergunta08();
					tela.setVisible(true);
					pergunta07.this.dispose();
		...
		JLabel lblNewLabel_1 = new JLabel("Quem eh impostor?");
